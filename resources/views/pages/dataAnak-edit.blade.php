              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    ...
                    <input class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" name="nama" id="input-nama" type="text" placeholder="{{ __('Nama') }}" value="{{$anak->nama}}" required="true" aria-required="true"/>
                      @if ($errors->has('nama'))
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('tgl_lahir') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('tgl_lahir') ? ' is-invalid' : '' }}" name="tgl_lahir" id="input-tgl_lahir" type="date" placeholder="{{ __('') }}" value="{{$anak->tgl_lahir}}" required />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input class="form-control{{ $errors->has('usia') ? ' is-invalid' : '' }}" name="usia" id="input-usia" type="text" placeholder="{{ __('usia') }}" value="{{$anak->usia}}" required="true" aria-required="true"/>
                        @if ($errors->has('usia'))
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input class="form-control{{ $errors->has('anak_ke') ? ' is-invalid' : '' }}" name="anak_ke" id="input-anak_ke" type="text" placeholder="{{ __('anak_ke') }}" value="{{$anak->anak_ke}}" required="true" aria-required="true"/>
