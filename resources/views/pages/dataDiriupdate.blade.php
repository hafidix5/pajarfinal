                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input class="form-control{{ $errors->has('nama_pasangan') ? ' is-invalid' : '' }}" name="nama_pasangan" id="input-nama_pasangan" type="text" placeholder="{{ __('Nama Pasangan') }}" value="{{$pasien->nama_pasangan ?? '' }}" required="true" aria-required="true"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input class="form-control{{ $errors->has('tgl_lahir_pasangan') ? ' is-invalid' : '' }}" name="tgl_lahir_pasangan" id="input-tgl_lahir_pasangan" type="date" placeholder="{{ __('') }}" value="{{$pasien->tgl_lahir_pasangan??''}}" required />
